...
from .transformer import WindowAttention, Mlp, window_partition, cyclic_shift, window_reverse, PatchMerging, \
    PatchExpand
...
class SwinUNetBlock(nn.Module):
    ...
    def forward(self, x, contrast_embed=None):
        ...
        if self.cross_contrast_attn:
            attn_windows, _ = self.attn(x_q=x_windows_embedded, x_k=x_windows_embedded, x_v=x_windows,
